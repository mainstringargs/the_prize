...
def get_all_files_from_day(directory_path, specific_day, league):
...
for league in leagues:
    ...
    newest_files = get_all_files_from_day(directory_path, formatted_date, league)
                        ...
                        for stat_line in stat_lines:
                            ...
                            if key not in existing_props:
                                ...
                                csv_row = (
                                    ...
                                    competition_state, competition_sport, away_team_abbr, home_team_abbr, prop_name,
                                    prop_abbr, prop_line
                                )
...
with open(csv_file_name, 'w', newline='') as csvfile:
    ...
    # Write rows
    csv_writer.writerows(list(csv_rows))
