...
for team in team_data:
    ...
    for event in team_data[team]:
        #print('event',event)
        if 'Pass Yards' in event and 'Receiving Yards' in event and len(event['Pass Yards']) == 1 and len(event['Receiving Yards']) > 2:      
         ...
         #   print('pass_result',pass_result)
            ...
            if pass_result == receiving_result1 and pass_result == receiving_result2 and pass_result == receiving_result3:
                ...
                if pass_result == 'Under':
                    ...
                    team_matches.append((pass_name, receiving_name1, receiving_name2, receiving_name3, 'Under'))
                elif pass_result == 'Over':
                    raw_over_match_count = raw_over_match_count + 1 
                    team_raw_over = team_raw_over + 1
                    team_matches.append((pass_name, receiving_name1, receiving_name2, receiving_name3, 'Over'))
